...
![](images/murders.png?classes=shadow)
...
Start with the `glimpse()` funtion from **dplyr**-- it will give a brief look at the variables in the data set and the data type. 
...
![](images/3dfs.png?classes=shadow?width=20pc)
...
![](images/select.png?classes=shadow)
...
![](images/mutate1.png?classes=shadow)
...
![](images/white.png?classes=shadow)
