...
* Timespan was between 1982 and 2001
* Female victims
...
![](images/counties.png?classes=shadow)
...
![](images/msagrp.png?classes=shadow)

Alright, we have more than 10,000 clusters.

Hargrove says we can filter it futher.
...
Let's expand the scope apply what we did to MSAs to Counties.

Why is this distinction imporant? Well, Metro Statistical Areas are smaller than Counties.

Counties are so large that they're often covered by multiple agencies like town police departments and state police and sheriff's deputies focusing on different jurisdictions. Serial killers aren't limited to by their geography, so it's important to expand the scope.
...
Do you think a killer might be targetting a specific age group?

You could filter the age like we did with years or we could create age categories with the data.

Categorical data has been very useful so far. We can turn a continous variable like age into a categorical variable by dividing it into bins. 
