...
description: "http://learn.r-journalism.com/en/wrangling/"
output:
  html_document:
    toc: true
    toc_float: true
...
This is from the [third chapter](https://learn.r-journalism.com/en/wrangling/strings/strings/) of [learn.r-journalism.com](https://learn.r-journalism.com/).
...
`str_view(string, pattern)` shows the first match
`str_view_all(string, pattern)` shows all matches
...
Learn more about regex for total control over strings.
